...
const LoginForm = () => {
  const onHandleGoogleSignIn = () => {
    window.location.href =
      "http://localhost:8080/oauth2/authorization/google?prompt=select_account&prompt=consent&max_age=0";
  };
  const logout = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4 py-12 bg-[#F9FAFB] text-[#1F2937]">
      ...
      <div className="w-full max-w-[440px] bg-white border border-gray-100 rounded-2xl p-6 sm:p-8 shadow-sm">
        ...
        <Button className="w-full mt-6 py-3 px-4 bg-[#5E52FF] hover:bg-[#4E42EF] text-white font-semibold text-sm rounded-xl shadow-md transition-all active:scale-[0.99]">
          Log In
        </Button>
      </div>
